  ...
  return (
    <>
          ...
          <ul className="nav-links">
            ...
            <li className={`dropdown${openDropdown === 'services' ? ' open' : ''}`}>
              ...
              <div className="dropdown-menu" onClick={() => setOpenDropdown(null)}>
                ...
                <Link href="/services/power-washing">Power Washing</Link>
              </div>
            </li>
      ...
      <div className={`mobile-nav${mobileNavOpen ? ' open' : ''}`}>
        ...
        <Link href="/services/power-washing" className="mobile-sub" onClick={() => setMobileNavOpen(false)}>Power Washing</Link>
