...
export const SERVICES_DATA: Record<string, ServiceData> = {
  ...
  'power-washing': {
    slug: 'power-washing',
    title: 'Power Washing',
    metaTitle: 'Power Washing in the Bay Area | Driveways, Siding, Decks | JB Lawn Care',
    metaDescription: 'Professional power washing and soft washing for Bay Area homes and businesses. Driveways, sidewalks, patios, decks, siding, fences, and roofs. Serving Oakland to Fremont. Call 341-260-0331.',
    heroKeyword: 'power washing Bay Area',
    headline: 'Power Washing for Bay Area Homes & Businesses',
    subheadline: 'Years of grime gone in an afternoon. Driveways, siding, decks, and more, cleaned right.',
    intro: "Dirt, algae, moss, and grime build up on every outdoor surface over time, and no amount of scrubbing by hand keeps up with it. A driveway that has gone gray, siding streaked with green, a deck that looks tired, a walkway slick with moss. JB Lawn Care provides professional power washing for homes and businesses across Oakland, Hayward, Fremont, Berkeley, and the entire East Bay. We clean hard surfaces with high-pressure washing and use gentler soft washing on siding, roofs, and anything that could be damaged by too much force. The result is a property that looks years newer, usually in a single visit.",
    whatsIncluded: [
      'Driveway, sidewalk, and walkway cleaning',
      'Patio, deck, and paver washing',
      'House siding and stucco (soft wash for delicate surfaces)',
      'Fence cleaning and restoration',
      'Roof soft washing to remove moss and algae',
      'Commercial storefronts, entryways, and parking areas',
      'Rust, oil, and stain treatment where possible',
      'Full cleanup, we leave the area rinsed and tidy',
    ],
    howItWorks: [
      { step: 1, title: 'Get a Free Estimate', desc: "Tell us what you need cleaned, or send a few photos. We'll assess the surfaces and give you a clear, flat-rate price with no hidden fees." },
      { step: 2, title: 'We Match the Method to the Surface', desc: "Hard surfaces like concrete and pavers get high-pressure washing. Delicate surfaces like siding and roofs get soft washing, lower pressure with the right cleaning solution, so nothing gets damaged." },
      { step: 3, title: 'We Clean & Rinse', desc: "Our crew does the work start to finish, then rinses everything down and cleans up. You come back to a property that looks like new." },
    ],
    pricingContext: "Power washing is priced by the surface and square footage, so a single driveway costs a lot less than a full house exterior plus driveway and deck. We quote flat rates after seeing the space (in person or by photo), and the price we give you is the price you pay, no hidden fees. Many customers bundle power washing with lawn care or a yard cleanup and we'll work it into one visit.",
    faqs: [
      { q: 'What can you power wash?', a: 'Just about any outdoor surface: driveways, sidewalks, walkways, patios, decks, pavers, house siding and stucco, fences, and roofs. We handle both residential properties and commercial spaces like storefronts, entryways, and parking areas.' },
      { q: 'Will power washing damage my siding or roof?', a: 'Not the way we do it. Siding, stucco, and roofs get soft washing instead of high pressure, lower pressure paired with a cleaning solution that lifts algae and grime without forcing water behind panels or stripping shingles. We match the method to the surface every time.' },
      { q: 'How often should I have my property power washed?', a: 'Most Bay Area homes benefit from a wash once a year. Shaded or north-facing surfaces collect moss and algae faster in our damp winters and may need it more often. Driveways and high-traffic areas also show grime sooner than the rest of the house.' },
      { q: 'Do you do commercial power washing?', a: 'Yes. We clean storefronts, entryways, sidewalks, and parking areas for Bay Area businesses. Regular washing keeps a commercial property looking cared for and removes the gum, oil, and grime that build up in high-traffic spots.' },
    ],
    relatedServices: ['yard-cleanup', 'junk-hauling', 'landscaping'],
    relatedAreas: ['oakland', 'hayward', 'fremont', 'san-leandro'],
  },
}
