...
export const SERVICES_DATA: Record<string, ServiceData> = {
  ...
  'pressure-washing': {
    ...
    metaTitle: 'Pressure Washing in the Bay Area | Driveways, Siding, Decks | JB Lawn Care',
    metaDescription: 'Professional pressure washing and soft washing for Bay Area homes and businesses. Driveways, sidewalks, patios, decks, siding, fences, and roofs. Serving Oakland to Fremont. Call 341-260-0331.',
    heroKeyword: 'pressure washing Bay Area',
    headline: 'Pressure Washing for Bay Area Homes & Businesses',
    ...
    pricingContext: "Pressure washing is priced by the surface and square footage, so a single driveway costs a lot less than a full house exterior plus driveway and deck. We quote flat rates after seeing the space (in person or by photo), and the price we give you is the price you pay, no hidden fees. Many customers bundle pressure washing with lawn care or a yard cleanup and we'll work it into one visit.",
    faqs: [
      { q: 'What can you pressure wash?', a: 'Just about any outdoor surface: driveways, sidewalks, walkways, patios, decks, pavers, house siding and stucco, fences, and roofs. We handle both residential properties and commercial spaces like storefronts, entryways, and parking areas.' },
      { q: 'Will pressure washing damage my siding or roof?', a: 'Not the way we do it. Siding, stucco, and roofs get soft washing instead of high pressure, lower pressure paired with a cleaning solution that lifts algae and grime without forcing water behind panels or stripping shingles. We match the method to the surface every time.' },
      { q: 'How often should I have my property pressure washed?', a: 'Most Bay Area homes benefit from a wash once a year. Shaded or north-facing surfaces collect moss and algae faster in our damp winters and may need it more often. Driveways and high-traffic areas also show grime sooner than the rest of the house.' },
      { q: 'Do you do commercial pressure washing?', a: 'Yes. We clean storefronts, entryways, sidewalks, and parking areas for Bay Area businesses. Regular washing keeps a commercial property looking cared for and removes the gum, oil, and grime that build up in high-traffic spots.' },
    ],
